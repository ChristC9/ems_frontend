...
// Define SVG icons inline to avoid import issues
...
const navigation = [
  ...
  { name: "Job Postings", href: "/job-postings", icon: BriefcaseIcon },
  { name: "Applications", href: "/applications", icon: DocumentTextIcon },
  { name: "Recruitment", href: "/recruitment", icon: CalendarDaysIcon },
  { name: "Payroll", href: "/payroll", icon: CurrencyDollarIcon },
  { name: "Timekeeping", href: "/timekeeping", icon: ClockIcon },
  ...
  { name: "Audit", href: "/audit", icon: ShieldCheckIcon },
]
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white shadow-xl">
          <div className="flex h-16 items-center justify-between px-4 border-b">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <div className="text-lg font-bold text-gray-900">META ARC</div>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200 pt-5 pb-4 overflow-y-auto">
          <div className="flex items-center flex-shrink-0 px-4 py-4">
            <img className="h-10 w-auto" src="/logo.webp" alt="Meta Arc" />
            <div className="ml-3">
              <div className="text-xl font-bold text-gray-900">META ARC</div>
              <div className="text-xs text-gray-500">Employee Management System</div>
            </div>
          </div>
      ...
      <div className="lg:pl-64 flex flex-col flex-1">
        ...
        <div className="sticky top-0 z-10 flex h-16 bg-white shadow-sm border-b border-gray-200">
          ...
          <div className="flex-1 px-4 flex justify-between items-center">
            <div className="flex items-center">
              <img className="h-6 w-auto lg:hidden" src="/logo.webp" alt="Meta Arc" />
              <div className="ml-2 lg:hidden">
                <span className="text-sm font-bold text-gray-900">META ARC</span>
              </div>
            </div>
